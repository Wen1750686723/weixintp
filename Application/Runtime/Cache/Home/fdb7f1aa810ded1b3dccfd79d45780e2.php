...
<div class="container">
   <div>修改站内信</div>
   <form action="/yintong/index.php/Home/Site/letterreceive" method="post">
   <input type="text" value="<?php echo $letter["id"]; ?>" name="id"/>
   <table border="1" width="700">
     <tr>
       <td><div class="fig">客户:</div><input type="text" name="client" value="<?php echo $letter["touserid"]; ?>"/></td>
       <td><div class="fig">标题:</div><input type="text" name="title" value="<?php echo $letter["title"]; ?>"/></td>
     </tr>
     <tr>
       <td align="right">内容:</td><td><textarea name="content" id="" cols="30" rows="10"><?php echo $letter["text"]; ?></textarea></td>
     </tr>
