...
<div class="container">
   <div>添加公告</div>
   <form action="/yintong/index.php/Home/Site/announce" method="post">
   <table border="1" width="700">
     <tr>
       <td><div class="fig">客户:</div><input type="text" name="client"/></td>
       <td><div class="fig">内容:</div><input type="text" name="content"/></td>
     </tr>
     <tr>
       <td><div class="fig">费用：</div><input type="text" name="fee"/></td>
       <td><div class="fig">图片地址：</div> <input type="text" name="address"/></td>
     </tr>
     <tr>
       <td><div class="fig">开始时间：</div><input type="text" style="border:1px solid #999;" onclick="fPopCalendar(event,this,this)" onfocus="this.select()" readonly="readonly" name="starttime"/></td>
       <td> <div class="fig">结束时间：</div><input type="text" style="border:1px solid #999;" onclick="fPopCalendar(event,this,this)" onfocus="this.select()" readonly="readonly" name="endtime"/></td>
     </tr>
     <tr>
       <td><div class="fig">链接：</div><input type="text" name="link"/></td>
       <td></td>
     </tr>
     <tr>
        <td></td>
   ...
   <table border="1">
	...
	<?php
 foreach ($link as $key => $value) { echo "<tr>"; echo "<th>".$value["promoteclient"]."</th>"; echo "<th>".$value["text"]."</th>"; echo "<th>".$value["promotelink"]."</th>"; echo "<th>".$value["promotefee"]."</th>"; echo "<th>".$value["promoteimg"]."</th>"; echo "<th>".date("Y-m-d",$value["starttime"])."</th>"; echo "<th>".date("Y-m-d",$value["endtime"])."</th>"; echo "<th><a href= \""."/yintong/index.php/Home/Site/announceupdate/id/".$value["id"]."\">修改</a>"."</th>"; echo "<th><a href= \""."/yintong/index.php/Home/Site/announcedelete/id/".$value["id"]."\">删除</a>"."</th>"; echo "</tr>"; } ?>
  </table>
   <?php
 $CurrentPage=isset($_GET['page'])?$_GET['page']:1; $myPage=new pager($announcecount,intval($CurrentPage)); $pageStr= $myPage->GetPagerContent(); echo $pageStr; ?>
