...
<div class="container">
   <div>添加站内信</div>
   <form action="/yintong/index.php/Home/Site/letter" method="post">
   <table border="1" width="700">
     <tr>
       <td><div class="fig">客户:</div><input type="text" name="client"/></td>
       <td><div class="fig">标题:</div><input type="text" name="title"/></td>
     </tr>
     <tr>
       <td align="center" style="font-weight:bold;">内容:</td><td align="center"><textarea name="content" id="" cols="30" rows="10"></textarea></td>
     </tr>
   ...
   <table border="1" width="700">
	...
	<?php
 foreach ($letter as $key => $value) { echo "<tr>"; echo "<th>".$value["touserid"]."</th>"; echo "<th>".$value["title"]."</th>"; echo "<th>".$value["text"]."</th>"; echo "<th>".date("Y-m-d h:i:s",$value["date"])."</th>"; echo "<th><a href= \""."/yintong/index.php/Home/Site/letterupdate/id/".$value["id"]."\">修改</a>"."</th>"; echo "<th><a href= \""."/yintong/index.php/Home/Site/letterdelete/id/".$value["id"]."\">删除</a>"."</th>"; echo "</tr>"; } ?>
  </table>
</div>
</body>
</html>