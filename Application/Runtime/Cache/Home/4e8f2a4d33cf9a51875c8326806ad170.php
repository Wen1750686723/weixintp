...
<body>
   <div class="container">
   	<form action="/thinkphp_3.2.3_full/index.php/Home/Test/addsubject" method="post">
	科目: <input type="text" name="name"><br/><br/><br/>
	简介: <br/><textarea rows="3" cols="20" name="instroction"></textarea><br/><br/><br/>
	<input type="submit">
	</form>
	<table border="1">
	<tr>
