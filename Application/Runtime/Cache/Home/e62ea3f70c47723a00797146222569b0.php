...
<div class="container">
   <div>修改公告</div>
    <form action="/yintong/index.php/Home/Site/announcereceive" method="post">
    <input type="text" name="id" value="<?php echo $link["id"]; ?>" style="display:none;"/>
    <div>客户：</div><input type="text" name="client" value="<?php echo $link["promoteclient"]; ?>"/><br/>
   	<div>内容：</div><input type="text" name="content" value="<?php echo $link["text"]; ?>"/><br/>
   	<div>链接：</div><input type="text" name="link" value="<?php echo $link["promotelink"]; ?>"/><br/>
   	
   	<div>费用：</div><input type="text" name="fee" value="<?php echo $link["promotefee"]; ?>"/><br/>
   	<div>开始时间：</div><input type="text" style="border:1px solid #999;" onclick="fPopCalendar(event,this,this)" onfocus="this.select()" readonly="readonly" name="starttime" value="<?php echo date("Y-m-d",$link["starttime"]); ?>"/><br/>
   	<div>结束时间：</div><input type="text" style="border:1px solid #999;" onclick="fPopCalendar(event,this,this)" onfocus="this.select()" readonly="readonly" name="endtime" value="<?php echo date("Y-m-d",$link["endtime"]); ?>"/><br/>
   	<div>图片地址：</div><input type="text" name="address" value="<?php echo $link["promoteimg"]; ?>"/><br/>
   	<input type="submit" value="修改" />
   </form>
   <input type="submit" value="返回" onclick="window.history.back(-1);" />
   </div>
</body>
</html>